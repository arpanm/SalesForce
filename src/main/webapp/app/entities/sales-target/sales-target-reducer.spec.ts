...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESTARGET_LIST actions', async () => {
    ...
    it('dispatches FETCH_SALESTARGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALESTARGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALESTARGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALESTARGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALESTARGET actions', async () => {
      const expectedActions = [
        {
