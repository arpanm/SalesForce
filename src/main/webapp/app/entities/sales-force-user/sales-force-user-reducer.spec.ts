...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESFORCEUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SALESFORCEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALESFORCEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALESFORCEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALESFORCEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALESFORCEUSER actions', async () => {
      const expectedActions = [
        {
