...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INCENTIVESCHEME_LIST actions', async () => {
    ...
    it('dispatches FETCH_INCENTIVESCHEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INCENTIVESCHEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INCENTIVESCHEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INCENTIVESCHEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INCENTIVESCHEME actions', async () => {
      const expectedActions = [
        {
