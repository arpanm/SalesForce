...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './incentive.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INCENTIVE_LIST actions', async () => {
    ...
    it('dispatches FETCH_INCENTIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INCENTIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INCENTIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INCENTIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INCENTIVE actions', async () => {
      const expectedActions = [
        {
