...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sales-target-filter.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESTARGETFILTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SALESTARGETFILTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALESTARGETFILTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALESTARGETFILTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALESTARGETFILTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALESTARGETFILTER actions', async () => {
      const expectedActions = [
        {
