...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERCACHE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERCACHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERCACHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERCACHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERCACHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERCACHE actions', async () => {
      const expectedActions = [
        {
