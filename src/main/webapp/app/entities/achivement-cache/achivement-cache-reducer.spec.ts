...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACHIVEMENTCACHE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACHIVEMENTCACHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACHIVEMENTCACHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACHIVEMENTCACHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACHIVEMENTCACHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACHIVEMENTCACHE actions', async () => {
      const expectedActions = [
        {
