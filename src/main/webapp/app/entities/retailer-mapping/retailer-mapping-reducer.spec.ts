...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RETAILERMAPPING_LIST actions', async () => {
    ...
    it('dispatches FETCH_RETAILERMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RETAILERMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RETAILERMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RETAILERMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RETAILERMAPPING actions', async () => {
      const expectedActions = [
        {
